...
import org.cubeengine.module.basics.command.HealCommand;
...
import org.cubeengine.module.basics.command.ItemDBCommand;
...
public class Basics extends Module
{
    ...
    public void onEnable()
    {
        ...
        cm.addCommands(cm, this, new HealCommand(this, um, em, taskManager, cm, bs));
        em.registerListener(this, new UnlimitedListener(this, um));
        cm.addCommands( this, new InventoryCommands(this, invGuard));
        cm.addCommands(this, new ItemDBCommand(this));
